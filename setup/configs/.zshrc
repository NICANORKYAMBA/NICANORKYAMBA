...
get_network_info() {
    ...
    local network_info=""
    [[ -n $eth_ip ]] && network_info+="%F{046}───%F{039}🮤%F{051}🌐$eth_ip%f%F{039}🮥"
    [[ -n $vpn_ip ]] && network_info+="%F{046}───%F{039}🮤%F{226}🔒$vpn_ip%f%F{039}🮥"
    [[ -n $wifi_ip ]] && network_info+="%F{046}───%F{039}🮤%F{201}📡$wifi_ip%f%F{039}🮥"
...
if [ "$color_prompt" = yes ]; then
    ...
    PROMPT='%F{046}╭───%F{039}🮤%F{033}󰀄 %F{201}%B%n%b%f%F{039}🮥$(get_network_info)
%F{046}├───%F{039}🮤 %F{226}%B%(6~.%-1~/…/%4~.%5~)%b%f%F{039}🮥${vcs_info_msg_0_}$(git_status_detailed)
%F{046}├───%F{039}🮤$(get_cloud_context)%F{039}🮥
%F{046}╰──%F{196}⚡%F{208}❯%F{226}❯%F{046}❯%f '
    ...
    PS2="%F{046}├───%F{039}🮤 %F{226}%_%f %F{039}🮥 "
    PS3="%F{046}├───%F{039}🮤 %F{081}Select:%f %F{039}🮥 "
    PS4="%F{046}├───%F{039}🮤 %F{196}Debug:%f %F{039}🮥 "
fi
